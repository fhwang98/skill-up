package com.skillup.backend.global.util;
...
public class JWTUtil {
    ...
    private final Long accessTokenExpiresIn = 1000L * 60 * 60; // 1시간
    private final Long refreshTokenExpiresIn = 1000L * 60 * 60 * 24 * 14; // 14일

    @PostConstruct
    public void init() {
        // 환경변수로 받은 문자열을 static secretKey에 할당
